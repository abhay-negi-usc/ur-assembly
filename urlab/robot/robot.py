...
class Robot:
    ...
    def __init__(self, cfg, with_gripper=True):
        ...
        # (A rigidly HELD connector is a configs/frames.yaml frame, tool0 -> connector, selected
        # by name -- see urlab/tool_frames.py. The old connector_holder chain is retired.)
